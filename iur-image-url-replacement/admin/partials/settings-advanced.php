<?php
/**
 * تنظیمات پیشرفته افزونه IUR
 * 
 * این فایل شامل بخش تنظیمات پیشرفته افزونه جایگزینی تصاویر می‌باشد
 */

// اطمینان از دسترسی مستقیم به فایل وجود ندارد
if (!defined('ABSPATH')) {
    exit;
}
...
<table class="form-table">
    ...
    <fieldset>
      <?php foreach ($post_types as $type): ?>
        <label style="display: inline-block; margin: 6px 16px 6px 0;">
          <!-- تغییر نام فیلد به iur_settings[post_types][] -->
  ...
  <td>
    <label>
      <!-- تغییر نام فیلد به iur_settings[skip_existing] -->
  ...
  <td>
    <!-- تغییر نام فیلد به iur_settings[quality] -->
  ...
  <td>
    <label>
      <!-- تغییر نام فیلد به iur_settings[delete_after_replace] -->
    ...
    <p class="description" style="color: #dc3545; font-weight: 500;">
      ⚠️ <?php esc_html_e('Warning: This action cannot be undone. Original files will be deleted permanently.', 'iur'); ?>
    </p>
  </td>
</tr>
  ...
  <td>
    <div style="display: flex; gap: 20px; flex-wrap: wrap;">
      <div>
        ...
        <!-- تغییر نام فیلد به iur_settings[max_width] و اصلاح ساختار تگ -->
      ...
      <div>
        ...
        <!-- تغییر نام فیلد به iur_settings[max_height] و اصلاح ساختار تگ -->
